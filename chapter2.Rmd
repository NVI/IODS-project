...
```{r structural_overview, echo = FALSE, out.width = '\\maxwidth'}
str(learning2014)
```
...
```{r graphical_overview, echo = FALSE, out.width = '\\maxwidth'}
...
```{r multiple_regression, echo = FALSE, out.width = '\\maxwidth'}
...
```{r simple_regression, echo = FALSE, out.width = '\\maxwidth'}
...
```{r fit_plot, echo = FALSE, out.width = '\\maxwidth'}
plot(second_model, which = 1)
```

Constant variance of errors assumption holds well.

```{r qq_plot, echo = FALSE, out.width = '\\maxwidth'}
...
```{r leverage_plot, echo = FALSE, out.width = '\\maxwidth'}
